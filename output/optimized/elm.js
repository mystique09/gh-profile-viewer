...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {S: fragment, V: host, aa: path, ac: port_, af: protocol, ag: query};
	});
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{av: false, ax: r.ax, aB: r.aB, T: r.T, aH: r.aH, aS: r.aS, ap: r.ap, aV: r.aV}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{ax: $elm$http$Http$emptyBody, aB: r.aB, T: _List_Nil, aH: 'GET', aS: $elm$core$Maybe$Nothing, ap: $elm$core$Maybe$Nothing, aV: r.aV});
};
var $author$project$Main$User = F7(
	function (id, node_id, login, followers, following, avatar_url, message) {
		return {L: avatar_url, Q: followers, R: following, W: id, D: login, aG: message, Z: node_id};
	});
...
var $author$project$Main$userDecoder = A8(
...
var $author$project$Main$getUser = function (name) {
	return $elm$http$Http$get(
		{
			aB: A2($elm$http$Http$expectJson, $author$project$Main$GotUser, $author$project$Main$userDecoder),
			aV: 'https://api.github.com/users/' + name
		});
};
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		$author$project$Main$Loading,
		$author$project$Main$getUser('mystique09'));
};
...
var $author$project$Main$update = F2(
	function (msg, _v0) {
		if (!msg.$) {
			...
			return _Utils_Tuple2(
				$author$project$Main$Loading,
				$author$project$Main$getUser(user));
		} else {
			var res = msg.a;
			if (!res.$) {
				var user = res.a;
				return _Utils_Tuple2(
					$author$project$Main$Success(user),
				...
				switch (err.$) {
					case 3:
						var status = err.a;
						return (status === 403) ? _Utils_Tuple2(
							$author$project$Main$Failure(
								$elm$core$Maybe$Just('Too many request! You are ratelimmited.')),
							$elm$core$Platform$Cmd$none) : _Utils_Tuple2(
							$author$project$Main$Failure($elm$core$Maybe$Nothing),
							$elm$core$Platform$Cmd$none);
					case 4:
						var bodyErr = err.a;
						return _Utils_Tuple2(
							$author$project$Main$Failure(
								$elm$core$Maybe$Just(bodyErr)),
							$elm$core$Platform$Cmd$none);
					case 0:
						var badUrlERr = err.a;
						return _Utils_Tuple2(
							$author$project$Main$Failure(
								$elm$core$Maybe$Just(badUrlERr)),
							$elm$core$Platform$Cmd$none);
					case 1:
						return _Utils_Tuple2(
							$author$project$Main$Failure(
								$elm$core$Maybe$Just('Timedout!')),
							$elm$core$Platform$Cmd$none);
					default:
						return _Utils_Tuple2(
							$author$project$Main$Failure(
								$elm$core$Maybe$Just('Bad internet!')),
							$elm$core$Platform$Cmd$none);
				}
			}
		}
	});
var $author$project$Main$GetAnotherUserBasedOnString = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Main$loadingStyle = _List_fromArray(
	[
...
var $author$project$Main$successStyle = _List_fromArray(
	[
		A2($elm$html$Html$Attributes$style, 'padding', '1rem'),
		A2($elm$html$Html$Attributes$style, 'border', 'solid 1px'),
		A2($elm$html$Html$Attributes$style, 'min-width', '15rem'),
		A2($elm$html$Html$Attributes$style, 'max-width', '20rem')
	]);
...
var $author$project$Main$viewUser = function (model) {
	switch (model.$) {
		case 1:
			return A2(
				$elm$html$Html$div,
				$author$project$Main$loadingStyle,
				_List_fromArray(
					[
						A2(
						$elm$html$Html$p,
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Fething user...')
							]))
					]));
		case 2:
			var user = model.a;
			return A2(
				$elm$html$Html$div,
				$author$project$Main$successStyle,
				_List_fromArray(
					[
						A2(
						$elm$html$Html$div,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$src(user.L),
										$elm$html$Html$Attributes$height(50),
										$elm$html$Html$Attributes$width(50),
										$elm$html$Html$Attributes$alt(user.D)
									]),
								_List_Nil),
								A2(
								$elm$html$Html$h1,
						...
						_List_fromArray(
							[
								$elm$html$Html$text('NodeId: ' + user.Z)
							])),
						A2(
						$elm$html$Html$p,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text(
								'Id: ' + $elm$core$String$fromInt(user.W))
							])),
						A2(
						$elm$html$Html$p,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text(
								'Followers: ' + $elm$core$String$fromInt(user.Q))
							])),
						A2(
						$elm$html$Html$p,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text(
								'Following: ' + $elm$core$String$fromInt(user.R))
							]))
					]));
		default:
			var err = model.a;
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('User not found!')
								]))
						]));
			}
	}
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Github user fetcher')
					])),
				A2(
				$elm$html$Html$input,
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onInput($author$project$Main$GetAnotherUserBasedOnString),
						A2($elm$html$Html$Attributes$style, 'margin-bottom', '1rem')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('GetUser')
					])),
				$author$project$Main$viewUser(model)
			]));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{aF: $author$project$Main$init, aR: $author$project$Main$subscriptions, aU: $author$project$Main$update, aW: $author$project$Main$view});
